...
def merge_sort(linked_list):
  ...
  - Repatedly merge the sublists to produce sorted sublists until one remains
...
def merge(left, right):
  ...
  # Itarate over left and right until ew reach the tail node 
  ...
  # Discard fake head and set first merged as head
